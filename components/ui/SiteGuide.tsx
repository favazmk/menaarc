...
const STOPS: Stop[] = [
  ...
  {
    id: 'stats',
    says: 'That is the scale behind the five you just scrolled past — and the same hands on all of it.',
    side: 'right',
    lift: 6.5,
  },
  {
  ...
  {
    id: 'region',
    says: 'Tap a marker. The filled ones are places with a finished project you can go and stand in.',
    side: 'right',
    lift: 4.5,
  },
  {
